        ...
        <section class="doctor-profile">
            <div class="container">
                ...
                <div class="profile-body">
                    ...
                    <ul class="details">
                        <p>description for doctor.</p>
                        <li><strong>Education:</strong> BDS, Cairo University</li>                        
                        <li><strong>Phone:</strong> +20 101 234 5678</li>
                        <br>
                        <div class="line"></div>
                        <br>
                        <h3>Feedback</h3><br>
                    ...
                    <div class="bookinginfo">
                        ...
                        <li><strong>Location:</strong> Clinic Address, Cairo, Egypt</li>
                        <li><strong>Fees:</strong> $150</li><br>
                        <ul>
                            <li>
                    ...
                    <div class="book-appointment">
                        <a href="#" class="popup-with-form">Book an Appointment</a>
                    </div>
                    </div>
                </div>
            </div>
